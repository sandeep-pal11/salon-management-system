...
$id = $_GET['uid'];
$query = mysqli_query($connection, "select * from tbl_service where service_id=$id");
$data = mysqli_fetch_array($query);

$service_id = $data['service_id'];
$name = $data['service_name'];
$service_type =$data['service_type'];
$sub_category = $data['category_id'];
...
if (isset($_POST['btn_submit'])) {
    ...
    $price = $_POST['price'];
    $query = mysqli_query($connection, "UPDATE `tbl_service` SET `service_name`='$name',`description`='$description',`service_charge`='$price',`service_type`='$type',`category_id`='$s_category' WHERE service_id=$id");
    if ($query) {
            ...
            <div class="layout-page">
                ...
                <div class="content-wrapper">
                    ...
                    <div class="container-xxl flex-grow-1 container-p-y">
                        <h4 class="py-3 mb-4"><span class="text-muted fw-light">Forms/</span> Update Services</h4>
                            ...
                            <div class="col-xl">
                                <div class="card mb-4">
                                    <div class="card-header d-flex justify-content-between align-items-center">
                                        <h5 class="mb-0">Update services</h5>
                                    </div>
                                    <div class="card-body">
                                        <form id="frm1" method="post" class="needs-validation" enctype="multipart/form-data" novalidate>

                                            <div class="form-floating form-floating-outline mb-4">
                                                <input type="text" value="#<?php echo $service_id; ?>" class="form-control" id="floatingInput" aria-describedby="floatingInputHelp" disabled/>
                                                <label for="floatingInput">Service ID</label>
                                            </div>

                                            <div class="form-floating form-floating-outline mb-4">
                                                <input type="text" value="<?php echo $name; ?>" name="service_name" class="form-control" id="floatingInput" placeholder="Product name (require)" aria-describedby="floatingInputHelp" required />
                                            ...
                                            <div class="row mb-2">
                                                <div class="col">
                                                    <div class="form-floating form-floating-outline mb-4">
                                                        ...
                                                        <div class="invalid-feedback">Please Select sub-category of service</div>
                                                    </div>
                                                </div>
                                                <div class="col">
                                                    <div class="form-floating form-floating-outline mb-4">
                                                        <select class="form-select" id="exampleFormControlSelect1" name="service_type" aria-label="Default select example" required>
                                                            <option value="Male" <?php if($service_type=="Male"){echo "selected";}?> >Male</option>
                                                            <option value="Female" <?php if($service_type=="Female"){echo "selected";}?>>Female</option>
                                                        </select>
