...
$id = $_GET['uid'];
$query = mysqli_query($connection, "select * from tbl_customer where customer_id='$id'");
            ...
            <div class="layout-page">
                ...
                <div class="content-wrapper">
                    ...
                    <div class="container-xxl flex-grow-1 container-p-y">
                        <h4 class="py-3 mb-4"><span class="text-muted fw-light">Forms/</span> Customer Form</h4>
