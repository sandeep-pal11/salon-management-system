...
document.addEventListener("DOMContentLoaded", function () {
  const decreaseBtn = document.querySelector('.quantity-controller__btn.-decrease');
  const increaseBtn = document.querySelector('.quantity-controller__btn.-increase');
  const quantityInput = document.querySelector('.quantity-controller__number');
...
}, 5300); // Adjust timeout according to animation duration
